      ...
      <View style={styles.body}>
        ...
        <View style={styles.row}>
          ...
          <View style={styles.seeAllContainer}>
            <Pressable
              onPress={() =>
                router.push(user.role.toLowerCase() + "/home/blogs")
              }
            >
        ...
        <View style={styles.articles}>
          {blogData.map((blog) => (
            <Pressable
              key={blog.id}
              onPress={() =>
                router.push(user.role.toLowerCase() + `/home/blogs/${blog.id}`)
              }
            >
              <ArticleCard {...blog} />
            </Pressable>
        ...
        <View style={styles.row2}>
          <View style={styles.itemContainer}>
            <Pressable
              onPress={() =>
                router.push(user.role.toLowerCase() + "/home/forums")
              }
            >
            ...
            <Pressable
              onPress={() =>
                router.push(user.role.toLowerCase() + "/home/selfHelpVideos")
              }
            >
              <View style={styles.item}>
                <Image
