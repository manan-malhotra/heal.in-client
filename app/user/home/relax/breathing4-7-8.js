      ...
      >
          ...
          <>
            ...
            <Animated.View
              style={{
                ...
                borderRadius: circleWidth,
                ...StyleSheet.absoluteFill,
                transform: [{ translateY: 195 }, { translateX: translateLeft }],
              }}
            />
            <Animated.View
              style={{
                ...
                borderRadius: circleWidth,
                ...StyleSheet.absoluteFill,
                transform: [{ translateY: translateDown }, { translateX: 200 }],
              }}
            />
            <Animated.View
              style={{
                ...
                borderRadius: circleWidth,
                ...StyleSheet.absoluteFill,
                transform: [{ translateY: translateUp }, { translateX: -50 }],
              }}
            />
          </>
        </View>
        <View style={{ paddingTop: "80%" }}>
          <View style={styles.timerContainer}>
            ...
            {showPicker && (
              <TimerInput onIntervalChange={handleIntervalChange} />
            )}
          </View>
        </View>
      </View>
        ...
        return (
          <View style={styles.dropdownButtonStyle}>
            ...
            {selectedItem && selectedItem.title ? (
              ...
              <Text style={styles.dropdownButtonTxtStyle}>Select Time</Text>
            )}
