  ...
  const handleSubmit = async () => {
    ...
    if (length == data.length) {
      ...
      Alert.alert(
        ...
        "You have submitted " + length + " out of " + data.length + " options"
      );
    }
  };
    ...
    <>
      ...
      <View style={styles.body}>
        {data.length > 0 ? (
          <ScrollView>
            {data.map((item, index) => (
              <View style={styles.questionCard} key={item.question_id}>
                ...
                <View style={{ flexDirection: "row" }}>
                  <TouchableOpacity
                    style={
                      selectedOptions[item.question_id] === 0
                        ? styles.selectedOptionCard
                        : styles.optionCard
                    }
                    onPress={() => {
                      handleOptionSelected(item.question_id, 0);
                    }}
                  >
                    <Text
                      style={
                  ...
                  <TouchableOpacity
                    style={
                      selectedOptions[item.question_id] === 1
                        ? styles.selectedOptionCard
                        : styles.optionCard
                    }
                    onPress={() => {
                      handleOptionSelected(item.question_id, 1);
                    }}
                  >
                    <Text
                      style={
                ...
                <View style={{ flexDirection: "row" }}>
                  <TouchableOpacity
                    style={
                      selectedOptions[item.question_id] === 2
                        ? styles.selectedOptionCard
                        : styles.optionCard
                    }
                    onPress={() => {
                      handleOptionSelected(item.question_id, 2);
                    }}
                  >
                    <Text
                      style={
                  ...
                  <TouchableOpacity
                    style={
                      selectedOptions[item.question_id] === 3
                        ? styles.selectedOptionCard
                        : styles.optionCard
                    }
                    onPress={() => {
                      handleOptionSelected(item.question_id, 3);
                    }}
                  >
                    <Text
                      style={
