            ...
            <View style = {styles.consulation_row}>
              <View style={styles.consulation_card}>
                  <View style={styles.consulation_inner_card_left}>
                        <Image source={require('../assets/images/ConsultDoctor/doctor1.png')} style={styles.consulation_img}/>
                  </View>
              ...
              <View style={styles.consulation_card}>
                  <View style={styles.consulation_inner_card_left}>
                        <Image source={require('../assets/images/ConsultDoctor/doctor2.png')} style={styles.consulation_img}/>
                  </View>
                  <View style = {styles.consulation_inner_card_right}>
              ...
              <View style={styles.consulation_card}>
                  <View style={styles.consulation_inner_card_left}>
                        <Image source={require('../assets/images/ConsultDoctor/doctor3.png')} style={styles.consulation_img}></Image>
                  </View>
                  <View style = {styles.consulation_inner_card_right}>
